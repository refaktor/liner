...
// PasswordPrompt displays p, and then waits for user input. The input typed by
// the user is not displayed in the terminal.
func (s *State) SimplePrompt(prompt string) (string, error) {
	for _, r := range prompt {
		if unicode.Is(unicode.C, r) {
			return "", ErrInvalidPrompt
		}
...
const color_word2 = "\x1b[33m" // "\033[38;5;214m"
const color_num2 = "\x1b[35m" // "\033[38;5;202m"
const color_string2 = "\x1b[32m" // "\033[38;5;148m"
const color_comment = "\x1b[90m" // "\033[38;5;247m"
